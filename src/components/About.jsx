        ...
        <Fade direction="left" delay={0.2}>
          <div className="ps-14 w-[640px]">
            <p className="text-justify text-lg text-white">
              ...
              diseases affecting rice plants. Our platform leverages
              cutting-edge technology to provide an easy and efficient solution
              for identifying various diseases that can impact the health of
              rice crops. Through the seamless integration of image recognition
              technology, users can simply upload images of affected rice
              leaves, and our advanced algorithms will swiftly analyze and
